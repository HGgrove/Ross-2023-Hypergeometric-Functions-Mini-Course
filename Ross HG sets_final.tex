...
\begin{itemize}
    ...
    Let $x \in \R$. Recall the Maclaurian series for cosine and sine,
    ...
    Rewrite these two identities for sine and cosine in terms of the $_{0}F_{1}$ function using part (a). Then use the $_{0}F_{1}$ version of the double angle formula to compute $\sin(\frac{\pi}{3})$ in terms of $_{0}F_{1}$ functions.
    \end{itemize}
...
\item[\textbf{3.}] Read \underline{\href{https://uva.theopenscholar.com/files/ken-ono/files/rims_st_survey.pdf}{this summary}} on the introduction of hypergeometric moments by Ono, Saad, and Saikia.
